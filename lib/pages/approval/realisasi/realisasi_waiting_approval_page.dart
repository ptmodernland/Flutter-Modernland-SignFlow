...
class RealisasiWaitingApprovalPage extends StatefulWidget {
  const RealisasiWaitingApprovalPage({Key? key}) : super(key: key);

  @override
  State<RealisasiWaitingApprovalPage> createState() =>
      _RealisasiWaitingApprovalPageState();
}

class _RealisasiWaitingApprovalPageState
    extends State<RealisasiWaitingApprovalPage> {
  @override
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        "Realisasi Waiting Approval Page",
                              ...
                              dataList = ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return ItemApprovalWidget(
                                    requiredId: approvalItem.idRealisasi,
                                    isApproved: isApproved,
                                    itemCode: approvalItem.noRealisasi,
                                    date: approvalItem.tglBuat,
