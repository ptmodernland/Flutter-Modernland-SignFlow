...
class KoordinasiWaitingAllPage extends StatelessWidget {
  final String title;

  const KoordinasiWaitingAllPage({this.title = "Permintaan Koordinasi"});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => RekomendasiCubit(RekomendasiRepository())..fetchWaiting(),
      child: Scaffold(
        appBar: AppBar(
