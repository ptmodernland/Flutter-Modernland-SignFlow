...
import 'package:modernland_signflow/bloc/compare/compare_action_bloc.dart';
import 'package:modernland_signflow/bloc/compare/compare_action_event.dart';
import 'package:modernland_signflow/bloc/compare/compare_bloc.dart';
import 'package:modernland_signflow/bloc/compare/compare_comment_bloc.dart';
    ...
    return SafeArea(
      ...
      child: Stack(
        children: [
          ...
          BlocProvider<CompareActionBloc>(
            create: (context) => compareActionBloc,
            // Replace with your actual cubit instantiation
            child: BlocBuilder<CompareActionBloc, CompareState>(
              bloc: compareActionBloc,
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          "Detail Request #" + widget.idCompare,
                              ...
                              child: Column(
                                children: [
                                  ItemApprovalWidget(
                                    ...
                                    descriptiveText:
                                        removeHtmlTags(data.desc_compare ?? ""),
                    ...
                    BlocProvider(
                      create: (BuildContext context) {
                        return compareCommentBloc
                          ..add(
                              GetKomentarCompare(noCompare: widget.noCompare));
                      },
                      child: Column(
                        children: [
